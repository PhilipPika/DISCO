...
nice -n 19 python dgnm_main.py --starttime=$Spinstart --endtime=$Spinend --maskid=800 --lspinup=1 --inifile ../ini/cmd_m_50yrs_bio_def.ini --parameter_ini ../ini/params_m_bio.ini --species_ini=mon_bio_1200.ini
...
nice -n 19 python dgnm_main.py  --starttime=$Spinstart --endtime=$SimuEnd --maskid=800 --lspinup=0 --inifile ../ini/cmd_m_50yrs_bio_def.ini --parameter_ini ../ini/params_m_bio.ini --species_ini=mon_bio_1200.ini
...
#python dgnm_main.py --endtime=1953 --maskid=800 --lspinup=0 --inifile ../ini/cmd_m_50yrs_bio_def.ini
...
cd $TOCODE/core
python ../carbon/code/aggregate_timeseries.py --maskid=800 --inifile ../ini/cmd_m_50yrs_bio_def.ini --parameter_ini ../ini/params_m_bio.ini --species_ini=mon_bio_1200.ini
