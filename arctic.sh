...
python dgnm_main.py --endtime=1952 --maskid=1 --lspinup=1 --inifile ../ini/cmd_m_Arctic_bio_def.ini
...
python dgnm_main.py --endtime=2000 --maskid=1 --lspinup=0 --inifile ../ini/cmd_m_Arctic_bio_def.ini
