...
python dgnm_main.py --lspinup=1 --inifile ../ini/${cmd_file} --endtime=$SimuEnd --species_ini=${INI_file}.ini --outputdir=../../${Addon}_${INI_file}/bio/pkl/
